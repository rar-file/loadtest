...
class SimpleLoadTest:
    ...
    def auth(self, token: str, header: str = "Authorization", prefix: str = "Bearer ") -> SimpleLoadTest:
    ...
    def _create_pattern(self):
        ...
        if self._pattern_type == "constant":
            ...
            raise ValueError(f"Unknown pattern: {self._pattern_type}. Use: constant, ramp, spike, burst")
    ...
    def dry_run(self) -> dict:
        ...
        return {
            ...
            "endpoints": [
                ...
                for ep in self._endpoints
            ] if self._endpoints else [{"method": "GET", "path": "/", "url": self.target}],
